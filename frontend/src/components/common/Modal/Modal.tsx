...
export const Modal = ({ children, isOpen, setIsOpen, title }: ModalProps) => (
  <Transition.Root show={isOpen} as={Fragment}>
    <Dialog as="div" className={`${inter.className} relative z-50`} onClose={() => setIsOpen(false)}>
      <Transition.Child
        as={Fragment}
      ...
      <div className="fixed inset-0 z-10">
        <div className="flex justify-center h-full text-center items-center">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Panel className="overflow-y-auto relative h-full sm:max-h-[672px] text-left bg-white rounded-xl shadow-xl transition-all max-w-[80%] sm:max-w-2xl p-0">
